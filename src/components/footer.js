        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
              ...
              <h3 className="font-bold text-2xl mb-2">Hubungi</h3>
              <p>Heri Setiawan</p>
              <p>Jl. Diponegoro</p>
              <p>Bandung</p>
            </div>
            <div className="w-full px-4 mb-12 md:w-1/3">
              <h3 className="font-semibold text-xl text-white mb-5">Tulisan</h3>
          ...
          <div className="w-full pt-20 border-t border-slate-700">
            ...
            <p className="font-medium text-xs text-slate-500 text-center">2022 @ Heri Setiawan. Powered by Gatsby & Tailwind.</p>
          </div>
        </div>
      </footer>
      {/* Footer Section End */}
